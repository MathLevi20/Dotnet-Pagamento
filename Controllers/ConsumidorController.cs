...
namespace pagamento_prova.Controllers
{
    public class ConsumidorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Senha,Documento")] Consumidor consumidor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Senha,Documento")] Consumidor consumidor)
        {
            if (id != consumidor.Id)
            {
                return NotFound();
